...
const NotificationBell = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className="fixed sm:absolute left-4 right-4 sm:left-auto sm:right-0 mt-2 sm:w-96 max-w-md bg-white rounded-lg shadow-xl border border-gray-200 z-50 max-h-[70vh] sm:max-h-[600px] flex flex-col">
          {/* Header */}
          ...
          <div className="overflow-y-auto flex-1">
            {loading ? (
              ...
              <div className="text-center p-6 sm:p-8 text-gray-500">
                ...
                <p className="text-xs sm:text-sm mt-1">We'll notify you when something arrives</p>
              </div>
            ) : (
          ...
          {/* Footer */}
          {notifications.length > 0 && (
            <div className="border-t border-gray-200 p-2 sm:p-3 text-center">
              <button
                onClick={() => {
                  setIsOpen(false);
